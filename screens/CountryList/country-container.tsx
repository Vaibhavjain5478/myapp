  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.textContainer}>
        <Text style={styles.text} testID={`Capital-${index}`}>
          Capital: {item.capital}
        </Text>
        <Text style={styles.text} testID={`Population-${index}`}>
          Population: {item.population}{" "}
        </Text>
        <Text style={styles.text} testID={`LatLng-${index}`}>
          LatLng: {item.latlng.join(",")}
        </Text>
        <Button
